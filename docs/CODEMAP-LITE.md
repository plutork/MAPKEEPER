...
- World Build Wizard step 3 controls (ordered blocks 1..4: parameters -> generation -> accept/edit -> continue; `Continue` only) -> `crates/web/index.html`, `crates/web/src/lib.rs` (`step3-land-silhouette-flow-v2`)
