...
- World Build Wizard steps 3–5 (silhouette → tectonics tint → elevation generate → Finish) -> `crates/web/index.html`, `crates/web/src/lib.rs` (`step3-land-silhouette-flow-v2`, `step3-layout-pattern-bank-v1`, `world-pipeline--tectonics-v1`)
