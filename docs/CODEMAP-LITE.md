...
- Step-5 elevation bridge (`elevation_gen.rs`: geology band jitter + class-aware hex smooth; D-88 amends D-72 flat bridge; seed from world_id) -> `crates/core/src/elevation_gen.rs`, `crates/core/src/geology.rs` (re-export)
