...
- Step-5 elevation bridge (`elevation_gen.rs`: geology band jitter + class-aware hex smooth; D-88 amends D-72 flat bridge; seed from world_id + regenerate_nonce) -> `crates/core/src/elevation_gen.rs`, `crates/server/src/lib.rs`, `crates/web/src/lib.rs`
