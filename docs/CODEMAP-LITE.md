...
- Step-4 geology model (`geology` categorical, styles belts/shields/arcs, land-area-scaled multi-belt + seed-rotated layout on regenerate, coast-correct arcs + anti-speckle, elevation bridge) -> `crates/core/src/geology.rs` (`world-pipeline--tectonics-v1`, `geology-readable--preview-contrast`, D-63, D-72)
