...
- World Build Wizard steps 1–5 (size/grid blank preview → silhouette → tectonics → elevation → Finish; Back on steps 2–5; step 3 gen identity under Regenerate) -> `crates/web/index.html`, `crates/web/src/lib.rs` (`wizard-size-grid-step`, `step3-land-silhouette-flow-v2`, D-65/D-66/D-68/D-69, `world-pipeline--tectonics-v1`)
